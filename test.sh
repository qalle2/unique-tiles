...
python3 uniquetiles.py test-in/wolf3d.png          test-out/wolf3d-default.png  --tilesize 8 --verbose
python3 uniquetiles.py test-in/wolf3d.png          test-out/wolf3d-a.png        --tilesize 8 --tileorder a
echo

echo "=== These should cause 5 distinct errors ==="
python3 uniquetiles.py test-in/wolf3d.png     test-out/test1.png --tilesize 1
